...
prompt  APPLICATION 105 - Plagarism_Detection_System
--
-- Application Export:
--   Application:     105
--   Name:            Plagarism_Detection_System
--   Date and Time:   17:28 Friday June 16, 2023
--   Exported By:     ROCKTIM
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4770907102269916));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'ROCKTIM'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'Plagarism_Detection_System'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F105'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 5117901068387232 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 5118121856387232 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5121206272387243 + wwv_flow_api.g_id_offset,
  p_error_template=> 5117509371387230 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20230616172827',
  ...
  p_cust_authentication_process=> '.'||to_char(5126801159387263 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 5125502899387250 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5124823918387249 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5123814907387247 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5125824445387250 + wwv_flow_api.g_id_offset,
  p_default_button_template => 5118632537387232 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5120224024387241 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5120303269387241 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5122126240387244 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5121206272387243 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5121206272387243 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 5119709943387240 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5120116534387241 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5120804239387242 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ROCKTIM',
  p_last_upd_yyyymmddhh24miss=> '20230616172827',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5127122484387264 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 5151208979387904 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 5366802206711720 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
  p_tab_text => 'Home',
  p_tab_step => 1,
...
--application/shared_components/navigation/tabs/standard/t_students
wwv_flow_api.create_tab (
  p_id=> 5160804635973248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 20,
  p_tab_name=> 'T_STUDENTS',
  p_tab_text => 'Students',
  p_tab_step => 4,
...
--application/shared_components/navigation/tabs/standard/t_subjects
wwv_flow_api.create_tab (
  p_id=> 5166511262003592 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 40,
  p_tab_name=> 'T_SUBJECTS',
  p_tab_text => 'Subjects',
  p_tab_step => 8,
...
--application/shared_components/navigation/tabs/standard/t_departments
wwv_flow_api.create_tab (
  p_id=> 5160527014970281 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 50,
  p_tab_name=> 'T_DEPARTMENTS',
...
--application/shared_components/navigation/tabs/standard/t_assignments
wwv_flow_api.create_tab (
  p_id=> 5167011046013000 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 60,
  p_tab_name=> 'T_ASSIGNMENTS',
  p_tab_text => 'Assignments',
  p_tab_step => 6,
  p_tab_also_current_for_pages => '7',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/plagarism
wwv_flow_api.create_tab (
  p_id=> 5313421199371861 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 90,
  p_tab_name=> 'Plagarism',
  p_tab_text => 'Plagarism',
  p_tab_step => 14,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
--application/shared_components/navigation/tabs/parent/t_adminpanel
wwv_flow_api.create_toplevel_tab (
  p_id=> 5158003174676498 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'Admin Panel',
  p_tab_sequence=> 10,
  p_tab_name  => 'T_AdminPanel',
  p_tab_text  => 'Admin Panel',
  p_tab_target=> 'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::',
  p_current_on_tabset=> 'Admin Panel',
  p_tab_comment=> '');
...
--
--application/shared_components/user_interface/lov/assignment_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5368714532055008 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'ASSIGNMENT_LOV',
  p_lov_query=> 'select a_id d, a_id r'||chr(10)||
'from   assignment_master'||chr(10)||
'order by 1');
...
--application/shared_components/user_interface/lov/departments_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5170518244109704 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'DEPARTMENTS_LOV',
  p_lov_query=> 'select DEPT_NAME d, DEPT_ID r'||chr(10)||
'from   DEPT_MASTER'||chr(10)||
'order by 1');
...
--application/shared_components/user_interface/lov/dept_fac_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5222501161200149 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'DEPT_FAC_LOV',
  p_lov_query=> 'SELECT name d, fac_id r'||chr(10)||
'FROM  FACULTY_MASTER '||chr(10)||
'WHERE dept = :P11_DEPT'||chr(10)||
'');
...
--application/shared_components/user_interface/lov/faculty_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5221603192172392 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'FACULTY_LOV',
  p_lov_query=> 'select name d, fac_id r'||chr(10)||
'from   FACULTY_MASTER'||chr(10)||
'');
...
wwv_flow_api.create_list_of_values (
  p_id       => 5129705309387294 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(5129705309387294 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>5129821602387297 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5129917910387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130025599387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130110566387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130205595387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130307696387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130403871387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130506547387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130608846387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>5130704555387303 + wwv_flow_api.g_id_offset,
  p_lov_id=>5129705309387294 + wwv_flow_api.g_id_offset,
...
--application/shared_components/user_interface/lov/semester_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5341619195167831 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'SEMESTER_LOV',
  p_lov_query=> 'SELECT'||chr(10)||
'  display_value d,'||chr(10)||
'  return_value r'||chr(10)||
'FROM ('||chr(10)||
'  SELECT'||chr(10)||
'    LEVEL AS display_value,'||chr(10)||
'    LEVEL AS return_value'||chr(10)||
'  FROM dual'||chr(10)||
'  CONNECT BY LEVEL <= (SELECT TOTAL_SEM FROM "#OWNER#"."DEPT_MASTER" WHERE DEPT_ID = :P5_DEPT)'||chr(10)||
')'||chr(10)||
'');
...
--application/shared_components/user_interface/lov/student_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5292920119892030 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'STUDENT_LOV',
  p_lov_query=> 'select s_rollno d, s_id r'||chr(10)||
'from   STUDENT_MASTER'||chr(10)||
'order by 1');
...
--application/shared_components/user_interface/lov/subject_lov
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 5220921630158783 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'SUBJECT_LOV',
  p_lov_query=> 'select sub_name d, sub_id r'||chr(10)||
'from   SUBJECT_MASTER'||chr(10)||
'');
...
wwv_flow_api.create_page (
 ...
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230615101244'
  );
null;
...
begin
s:=s||'SELECT '||chr(10)||
'    ''Total Assignment'' AS "Tables",'||chr(10)||
'    COUNT(*) AS row_count'||chr(10)||
'FROM'||chr(10)||
'    assignment_master'||chr(10)||
'UNION ALL'||chr(10)||
'SELECT '||chr(10)||
'    ''Total Departments'' AS "Tables",'||chr(10)||
'    COUNT(*) AS row_count'||chr(10)||
'FROM'||chr(10)||
'    dept_master'||chr(10)||
'UNION ALL'||chr(10)||
'SELECT '||chr(10)||
'    ''Total Subjects'' AS "Tables",'||chr(10)||
'    COUNT(*) AS row_count'||chr(10)||
'FROM'||chr(10)||
'    subject_master'||chr(10)||
'UNION ALL'||chr(10)||
'SELECT '||chr(10)||
'    ''Total Students'' AS "Tables",'||chr(10)||
'    COUNT(*) AS row_count'||chr(10)||
'FROM'||chr(10)||
'    student_mast';
...
wwv_flow_api.create_report_region (
  p_id=> 5367921627032628 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_name=> 'Tables Report',
  p_region_name=>'',
  p_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  ...
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 5124823918387249+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 5368209373032631 + wwv_flow_api.g_id_offset,
  p_region_id=> 5367921627032628 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5368303542032631 + wwv_flow_api.g_id_offset,
  p_region_id=> 5367921627032628 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_branch(
  p_id=>5366104260689146 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 1,
...
prompt  ...PAGE 2: Department Report
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230615080920'
  );
null;
...
'where '||chr(10)||
'(   '||chr(10)||
' instr(upper("DEPT_NAME"),upper(nvl(:P2_REPORT_SEARCH,"DEPT_NAME"))) > 0 '||chr(10)||
')'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 5131028308387309 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_name=> 'Department Report',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5131112636387312 + wwv_flow_api.g_id_offset,
  p_region_id=> 5131028308387309 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  ...
  p_column_link=>'f?p=&APP_ID.:3:#APP_SESSION#::::P3_DEPT_ID:#DEPT_ID#',
  ...
  p_is_required=> false,
  p_pk_col_source=> s,
  p_ref_schema=> 'ROCKTIM',
  p_ref_table_name=> 'DEPT_MASTER',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5131207895387312 + wwv_flow_api.g_id_offset,
  p_region_id=> 5131028308387309 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5131310177387312 + wwv_flow_api.g_id_offset,
  p_region_id=> 5131028308387309 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  p_column_alias=> 'TOTAL_SEM',
  p_column_display_sequence=> 3,
  p_column_heading=> 'Total Sem',
  p_column_hit_highlight=>'&P2_REPORT_SEARCH.',
  p_column_alignment=>'RIGHT',
  p_heading_alignment=>'CENTER',
  p_disable_sort_column=>'N',
...
wwv_flow_api.create_page_plug (
  p_id=> 5132328802387320 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 5119709943387240+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(5128205733387275 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 5125824445387250+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5131626833387313 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 10,
  p_button_plug_id => 5131028308387309+wwv_flow_api.g_id_offset,
  p_button_name    => 'RESET',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 5134014767387330 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 10,
  p_button_plug_id => 5131028308387309+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5132025139387316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
...
wwv_flow_api.create_page_item(
  p_id=>5131407938387312 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 5131028308387309+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 5125502899387250+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5131517794387313 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_ROWS',
  p_data_type=> 'VARCHAR',
  ...
  p_lov=> '.'||to_char(5129705309387294 + wwv_flow_api.g_id_offset)||'.',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
  p_cMaxlength=> 2000,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5131700693387316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 2,
  p_name=>'P2_GO',
  p_data_type=> 'VARCHAR',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(5118632537387232 + wwv_flow_api.g_id_offset),
  p_begin_on_new_line=> 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan=> 1,
  p_rowspan=> 1,
...
wwv_flow_api.create_page_process(
  p_id     => 5131818814387316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
...
wwv_flow_api.create_page_process(
  p_id     => 5131908074387316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 2,
  ...
  p_process_when_button_id=>5131626833387313 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230616153304'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5132616112387320 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_plug_name=> 'Department Form',
  p_region_name=>'',
  p_plug_template=> 5120303269387241+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5203214911468258 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
wwv_flow_api.create_page_button(
  p_id             => 5132700957387321 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
  p_button_sequence=> 10,
  p_button_plug_id => 5132616112387320+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5132918203387321 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_button(
  p_id             => 5133027479387321 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_button(
  p_id             => 5132802422387321 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 3,
...
wwv_flow_api.create_page_branch(
  p_id=>5133204331387324 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5133300837387324 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_DEPT_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5132616112387320+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>5133408068387324 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_DEPT_NAME',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_item(
  p_id=>5133622280387328 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 3,
  p_name=>'P3_TOTAL_SEM',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:DEPT_MASTER:P3_DEPT_ID:DEPT_ID';

wwv_flow_api.create_page_process(
  p_id     => 5133808141387329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from DEPT_MASTER',
  p_process_sql_clob => p, 
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:DEPT_MASTER:P3_DEPT_ID:DEPT_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5133907457387329 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 3,
  p_process_sequence=> 1,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of DEPT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table DEPT_MASTER.',
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230615065652'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "S_ID", '||chr(10)||
'"S_ROLLNO",'||chr(10)||
'"S_NAME",'||chr(10)||
'"DEPT",'||chr(10)||
'"S_SEMESTER"'||chr(10)||
'from "#OWNER#"."STUDENT_MASTER" '||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5337724384085889 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Student Report',
  p_region_name=>'',
  p_plug_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_worksheet(
  p_id=> 5337904360085889+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 5337724384085889+wwv_flow_api.g_id_offset,
  p_name=> 'Student Report',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_link=>'f?p=&APP_ID.:5:&APP_SESSION.::::P5_S_ID:#S_ID#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 5338031776085890+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'S_ID',
  p_display_order          =>1,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5338106337085891+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'S_ROLLNO',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'S Rollno',
  p_report_label           =>'S Rollno',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5338229924085891+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'S_NAME',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'S Name',
  p_report_label           =>'S Name',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5338321083085891+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5338409080085891+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'S_SEMESTER',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'S Semester',
  p_report_label           =>'S Semester',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'S_ID:S_ROLLNO:S_NAME:DEPT:S_SEMESTER';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5339530829086068+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 5337904360085889+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5338702930085892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
begin
s:=s||'SELECT'||chr(10)||
'  s.S_ID as "Student Id",'||chr(10)||
'  s.S_ROLLNO as "Roll Number",'||chr(10)||
'  s.S_NAME as "Name",'||chr(10)||
'  d.DEPT_NAME as "Department",'||chr(10)||
'  s.S_SEMESTER as "Current Semester"'||chr(10)||
'FROM "#OWNER#"."STUDENT_MASTER" s'||chr(10)||
'INNER JOIN DEPT_MASTER d ON s.dept = d.dept_id';

wwv_flow_api.create_report_region (
  p_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_name=> 'Detailed Student Report',
  p_region_name=>'',
  p_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5340414866106875 + wwv_flow_api.g_id_offset,
  p_region_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'Student Id',
  p_column_display_sequence=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5340525155106875 + wwv_flow_api.g_id_offset,
  p_region_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'Roll Number',
  p_column_display_sequence=> 2,
  p_column_heading=> 'Roll Number',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5340617016106876 + wwv_flow_api.g_id_offset,
  p_region_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5340703450106876 + wwv_flow_api.g_id_offset,
  p_region_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5340824984106876 + wwv_flow_api.g_id_offset,
  p_region_id=> 5340104556106873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
  p_column_alias=> 'Current Semester',
  p_column_display_sequence=> 5,
  p_column_heading=> 'Current Semester',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
wwv_flow_api.create_page_button(
  p_id             => 5338602159085891 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 30,
  p_button_plug_id => 5337724384085889+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=105:5:&SESSION.::&DEBUG.:5',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230616153418'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5334007254085872 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5338922162085892 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5334312855085872 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 30,
  p_button_plug_id => 5334007254085872+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P5_S_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5334624831085873 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 10,
  p_button_plug_id => 5334007254085872+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5334229901085872 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 40,
  p_button_plug_id => 5334007254085872+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5334427912085872 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 20,
  p_button_plug_id => 5334007254085872+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5335209235085873 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5335401816085874 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_S_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5334007254085872+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'S Id',
  p_source=>'S_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5335616303085879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_S_ROLLNO',
  p_data_type=> 'VARCHAR',
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 5125714062387250+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_03 => 'right',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>5335813244085879 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_S_NAME',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5336002869085880 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_DEPT',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'DEPARTMENTS_LOV',
  p_lov=> 'select DEPT_NAME d, DEPT_ID r'||chr(10)||
'from   DEPT_MASTER'||chr(10)||
'order by 1',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5336209523085880 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_S_SEMESTER',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 50,
...
'',
  ...
  p_lov_null_text=>'',
  p_lov_null_value=> '',
  p_lov_cascade_parent_items=> 'P5_DEPT',
  p_ajax_items_to_submit=> 'P5_S_SEMESTER',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:STUDENT_MASTER:P5_S_ID:S_ID';

wwv_flow_api.create_page_process(
  p_id     => 5336528959085880 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from STUDENT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'  is '||chr(10)||
'  begin '||chr(10)||
'    for c1 in (select STUDENT_MASTER_SEQ.nextval next_val'||chr(10)||
'               from dual)'||chr(10)||
'    loop'||chr(10)||
...
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P5_S_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5336700723085882 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_when_button_id=>5334229901085872 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:STUDENT_MASTER:P5_S_ID:S_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5336923131085882 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of STUDENT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table STUDENT_MASTER.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5337126525085883 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  ...
  p_process_when_button_id=>5334427912085872 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 6: ASSIGNMENT REPORT
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 6
 ,p_tab_set => 'Admin Panel'
 ,p_name => 'ASSIGNMENT REPORT'
 ,p_step_title => 'ASSIGNMENT REPORT'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230615073324'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "A_ID", '||chr(10)||
'"A_TITLE",'||chr(10)||
'"A_DATE",'||chr(10)||
'"S_ID",'||chr(10)||
'"SUB_ID",'||chr(10)||
'"CONTENT"'||chr(10)||
'from "#OWNER#"."ASSIGNMENT_MASTER" '||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5349201171314886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'ASSIGNMENT REPORT',
  p_region_name=>'',
  p_plug_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5349412482314886+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_region_id=> 5349201171314886+wwv_flow_api.g_id_offset,
  p_name=> 'ASSIGNMENT REPORT',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:7:&APP_SESSION.::::P7_A_ID:#A_ID#',
  p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif"  border="0">',
  p_allow_exclude_null_values=>'Y',
  p_allow_hide_extra_columns=>'Y',
  p_icon_view_enabled_yn=>'N',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5349526784314887+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'A_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'A Id',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5349622256314887+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'A_TITLE',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'A Title',
  p_report_label           =>'A Title',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5349711132314887+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'A_DATE',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'A Date',
  p_report_label           =>'A Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5349825202314887+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'S_ID',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5349927015314887+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SUB_ID',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Sub Id',
  p_report_label           =>'Sub Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5350020448314888+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'A_ID:A_TITLE:A_DATE:S_ID:SUB_ID:CONTENT';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5351104668315030+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5349412482314886+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5350315410314888 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
begin
s:=s||'SELECT'||chr(10)||
'  A.A_ID AS "ASSIGNMENT ID",'||chr(10)||
'  A.A_TITLE AS "ASSIGNMENT TITLE",'||chr(10)||
'  A.A_DATE AS "SUBMITTED ON",'||chr(10)||
'  S.S_ROLLNO AS "SUBMITTED BY (Roll No)",'||chr(10)||
'  SUB.SUB_NAME AS "SUBJECT",'||chr(10)||
'  A.CONTENT AS "CONTENT"'||chr(10)||
'FROM'||chr(10)||
'  "#OWNER#"."ASSIGNMENT_MASTER" A'||chr(10)||
'  INNER JOIN "#OWNER#"."STUDENT_MASTER" S ON A.S_ID = S.S_ID'||chr(10)||
'  INNER JOIN "#OWNER#"."SUBJECT_MASTER" SUB ON A.SUB_ID = SUB.SUB_ID';

wwv_flow_api.create_report_region (
  p_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_name=> 'DETAILED ASSIGNMENT REPORT',
  p_region_name=>'',
  p_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 20,
  p_display_column=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5351918131333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'ASSIGNMENT ID',
  p_column_display_sequence=> 1,
  p_column_heading=> 'ASSIGNMENT ID',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5352017796333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'ASSIGNMENT TITLE',
  p_column_display_sequence=> 2,
  p_column_heading=> 'ASSIGNMENT TITLE',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5352102622333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  p_column_alias=> 'SUBMITTED ON',
  p_column_display_sequence=> 3,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5352203793333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  p_column_alias=> 'SUBMITTED BY (Roll No)',
  p_column_display_sequence=> 4,
  p_column_heading=> 'SUBMITTED BY (Roll No)',
  p_column_alignment=>'LEFT',
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
  p_hidden_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5352304963333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5352427760333242 + wwv_flow_api.g_id_offset,
  p_region_id=> 5351602160333241 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 5350208962314888 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 6,
  p_button_sequence=> 30,
  p_button_plug_id => 5349201171314886+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=105:7:&SESSION.::&DEBUG.:7',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page (
 ...
 ,p_id => 7
 ,p_tab_set => 'Admin Panel'
 ,p_name => 'ASSIGNMENT FORM'
 ,p_step_title => 'ASSIGNMENT FORM'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230616152944'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5345119900314881 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5350526955314888 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5345425765314882 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 30,
  p_button_plug_id => 5345119900314881+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P7_A_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5345700364314882 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 10,
  p_button_plug_id => 5345119900314881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5345320465314882 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 40,
  p_button_plug_id => 5345119900314881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5345520948314882 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 7,
  p_button_sequence=> 20,
  p_button_plug_id => 5345119900314881+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5346331086314882 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5346516304314883 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_A_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5345119900314881+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'A Id',
  p_source=>'A_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5346732405314883 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_A_TITLE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5346913670314883 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_A_DATE',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5347314160314885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_S_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'STUDENT_LOV',
  p_lov=> 'select s_rollno d, s_id r'||chr(10)||
'from   STUDENT_MASTER'||chr(10)||
'order by 1',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5347508338314885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_SUB_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'SUBJECT_LOV',
  p_lov=> 'select sub_name d, sub_id r'||chr(10)||
'from   SUBJECT_MASTER'||chr(10)||
'',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5347713409314885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 7,
  p_name=>'P7_CONTENT',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_validation(
  p_id => 5347208168314884 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_tabular_form_region_id => null + wwv_flow_api.g_id_offset,
  p_validation_name => 'P7_A_DATE must be timestamp',
  p_validation_sequence=> 30,
  p_validation => 'P7_A_DATE',
  p_validation_type => 'ITEM_IS_TIMESTAMP',
  p_error_message => '#LABEL# must be a valid timestamp.',
  p_associated_item=> 5346913670314883 + wwv_flow_api.g_id_offset,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:ASSIGNMENT_MASTER:P7_A_ID:A_ID';

wwv_flow_api.create_page_process(
  p_id     => 5348015138314885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from ASSIGNMENT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'  is '||chr(10)||
'  begin '||chr(10)||
'    for c1 in (select ASSIGNMENT_MASTER_SEQ.nextval next_val'||chr(10)||
'               from dual)'||chr(10)||
'    loop'||chr(10)||
'        return c1.next_val;'||chr(10)||
'    end loop;'||chr(10)||
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P7_A_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5348231653314885 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5345320465314882 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:ASSIGNMENT_MASTER:P7_A_ID:A_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5348410206314886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of ASSIGNMENT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table ASSIGNMENT_MASTER.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5348619332314886 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 7,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5345520948314882 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_id => 8
 ,p_tab_set => 'Admin Panel'
 ,p_name => 'SUBJECT_MASTER'
 ,p_step_title => 'SUBJECT_MASTER'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230601104805'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "SUB_ID", '||chr(10)||
'"SUB_NAME"'||chr(10)||
'from "#OWNER#"."SUBJECT_MASTER" '||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 5165725234001852 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_name=> 'SUBJECT_MASTER',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5166030928001854 + wwv_flow_api.g_id_offset,
  p_region_id=> 5165725234001852 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  ...
  p_column_link=>'f?p=#APP_ID#:9:#APP_SESSION#::::P9_SUB_ID:#SUB_ID#',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5166108226001854 + wwv_flow_api.g_id_offset,
  p_region_id=> 5165725234001852 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  ...
  p_pk_col_source=> s,
  p_ref_schema=> 'ROCKTIM',
  p_ref_table_name=> 'SUBJECT_MASTER',
  p_ref_column_name=> 'SUB_NAME',
  p_column_comment=>'');
end;
/
declare
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5203910110495257 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5166305694001854 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 30,
  p_button_plug_id => 5165725234001852+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=105:9:&SESSION.::&DEBUG.:9',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230616153233'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5162715511001842 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'SUBJECT_MASTER',
  p_region_name=>'',
  p_plug_template=> 5120303269387241+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5204322231498781 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5163027020001842 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  p_button_plug_id => 5162715511001842+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P9_SUB_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5163314387001842 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 5162715511001842+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5162926341001842 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 40,
  p_button_plug_id => 5162715511001842+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5163108903001842 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 20,
  p_button_plug_id => 5162715511001842+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5163931767001846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5164116572001846 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_SUB_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5162715511001842+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Sub Id',
  p_source=>'SUB_ID',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5164317189001850 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
  p_name=>'P9_SUB_NAME',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:SUBJECT_MASTER:P9_SUB_ID:SUB_ID';

wwv_flow_api.create_page_process(
  p_id     => 5164612667001851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from SUBJECT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to fetch row.',
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
...
'  is '||chr(10)||
'  begin '||chr(10)||
'    for c1 in (select SUBJECT_MASTER_SEQ.nextval next_val'||chr(10)||
'               from dual)'||chr(10)||
'    loop'||chr(10)||
'        return c1.next_val;'||chr(10)||
'    end loop;'||chr(10)||
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P9_SUB_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5164831688001851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5162926341001842 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:SUBJECT_MASTER:P9_SUB_ID:SUB_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5165025195001851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of SUBJECT_MASTER',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table SUBJECT_MASTER.',
  p_process_success_message=> 'Action Processed.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 5165224742001851 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5163108903001842 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'Admin Panel'
 ,p_name => 'User Auth'
 ,p_step_title => 'User Auth'
 ,p_allow_duplicate_submissions => 'Y'
 ,p_step_sub_title => 'User Auth'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_first_item => 'AUTO_FIRST_ITEM'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_autocomplete_on_off => 'ON'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230601093323'
  );
null;
...
'"PASSWORD",'||chr(10)||
'"ROLE"'||chr(10)||
' from   "USER_AUTH" '||chr(10)||
'where '||chr(10)||
'(   '||chr(10)||
' instr(upper("EMAIL"),upper(nvl(:P13_REPORT_SEARCH,"EMAIL"))) > 0  or'||chr(10)||
' instr(upper("PASSWORD"),upper(nvl(:P13_REPORT_SEARCH,"PASSWORD"))) > 0  or'||chr(10)||
' instr(upper("ROLE"),upper(nvl(:P13_REPORT_SEARCH,"ROLE"))) > 0 '||chr(10)||
')'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 5149714660387352 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_name=> 'USER_AUTH',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5149808423387354 + wwv_flow_api.g_id_offset,
  p_region_id=> 5149714660387352 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  ...
  p_pk_col_source=> s,
  p_ref_schema=> 'ROCKTIM',
  p_ref_table_name=> 'USER_AUTH',
  p_ref_column_name=> 'AUTH_ID',
  p_column_comment=>'');
end;
/
declare
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5149918637387354 + wwv_flow_api.g_id_offset,
  p_region_id=> 5149714660387352 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5150022653387354 + wwv_flow_api.g_id_offset,
  p_region_id=> 5149714660387352 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5150122481387354 + wwv_flow_api.g_id_offset,
  p_region_id=> 5149714660387352 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5151008167387356 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5150412110387354 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 13,
  p_button_sequence=> 10,
  p_button_plug_id => 5149714660387352+wwv_flow_api.g_id_offset,
  p_button_name    => 'RESET',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Reset',
  p_button_position=> 'REGION_TEMPLATE_CLOSE',
...
wwv_flow_api.create_page_branch(
  p_id=>5150819013387356 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5150204398387354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5149714660387352+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_prompt=>'Search',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5150316818387354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_ROWS',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5150527827387354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 13,
  p_name=>'P13_GO',
  p_data_type=> 'VARCHAR',
...
wwv_flow_api.create_page_process(
  p_id     => 5150600297387354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5150729964387354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 13,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to clear cache.',
  p_process_when_button_id=>5150412110387354 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'Admin Panel'
 ,p_name => 'Plagarism  '
 ,p_step_title => 'Plagarism  '
 ,p_step_sub_title => 'Plagarism  '
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
...
'No help is available for this page.'
 ,p_last_updated_by => 'ROCKTIM'
 ,p_last_upd_yyyymmddhh24miss => '20230615102021'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5323408701651866 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5318029032555664 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_plug_name=> 'Plagarism Check Form',
  p_region_name=>'',
  p_parent_plug_id=>5323408701651866 + wwv_flow_api.g_id_offset,
  p_plug_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
...
begin
s:=s||'SELECT '||chr(10)||
'  ROW_NUMBER() OVER (ORDER BY t1.a_id) AS Sl_no,'||chr(10)||
'  t1.a_id AS "Reference A_Id",'||chr(10)||
'  t1.a_title AS "Reference A_Title",'||chr(10)||
'  t1.a_date AS "Reference Submitted_On",'||chr(10)||
'  s1.s_rollno AS "Reference S_Rollno",'||chr(10)||
'  s1.s_name AS "Reference Submitted_by",'||chr(10)||
'  sub1.sub_name AS "Reference A_Subject",'||chr(10)||
'  t2.a_id AS "Comparison A_Id",'||chr(10)||
'  t2.a_title AS "Comparison A_Title",'||chr(10)||
'  t2.a_date AS "Comparison Submitted_On",'||chr(10)||
'';

s:=s||'  s2.s_rollno AS "Comparison S_Rollno",'||chr(10)||
'  s2.s_name AS "Comparison Submitted_by",'||chr(10)||
'  sub2.sub_name AS "Comparison A_Subject",'||chr(10)||
'  ROUND('||chr(10)||
'    CASE WHEN LENGTH(t1.content) <= LENGTH(t2.content)'||chr(10)||
'         THEN calculate_jaccard(lower(t1.content), lower(t2.content))'||chr(10)||
'         ELSE calculate_jaccard(lower(t2.content), lower(t1.content))'||chr(10)||
'    END,'||chr(10)||
'    2'||chr(10)||
'  ) AS "Plag(%)"'||chr(10)||
'FROM assignment_master t1'||chr(10)||
'INNER JOIN as';

s:=s||'signment_master t2 ON t1.a_id <> t2.a_id'||chr(10)||
'INNER JOIN STUDENT_MASTER s1 ON t1.s_id = s1.s_id '||chr(10)||
'INNER JOIN STUDENT_MASTER s2 ON t2.s_id = s2.s_id'||chr(10)||
'INNER JOIN SUBJECT_MASTER sub1 ON t1.sub_id = sub1.sub_id'||chr(10)||
'INNER JOIN SUBJECT_MASTER sub2 ON t2.sub_id = sub2.sub_id'||chr(10)||
'WHERE'||chr(10)||
'  ('||chr(10)||
'    :p14_A_ID IS NULL'||chr(10)||
'    OR t1.a_id = :p14_A_ID'||chr(10)||
'  )'||chr(10)||
'  AND'||chr(10)||
'  ('||chr(10)||
'    :p14_A_ID_1 IS NULL'||chr(10)||
'    OR t2.a_id = :p14_A_ID_1'||chr(10)||
'  )'||chr(10)||
'ORDER BY t1.';
...
wwv_flow_api.create_report_region (
  p_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 14,
  p_name=> 'Plagarism Report',
  p_region_name=>'',
  p_parent_plug_id=>5323408701651866 + wwv_flow_api.g_id_offset,
  p_template=> 5121206272387243+ wwv_flow_api.g_id_offset,
  p_display_sequence=> 20,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320204731579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'SL_NO',
  p_column_display_sequence=> 1,
  p_column_heading=> 'SL_NO',
  p_column_alignment=>'LEFT',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320305091579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
  p_column_alias=> 'Reference A_Id',
  p_column_display_sequence=> 2,
  p_column_heading=> 'Reference A_Id',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320422579579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
  p_column_alias=> 'Reference A_Title',
  p_column_display_sequence=> 3,
  p_column_heading=> 'Reference A_Title',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320516690579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  p_column_alias=> 'Reference Submitted_On',
  p_column_display_sequence=> 4,
  p_column_heading=> 'Reference Submitted_On',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320629667579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
  p_column_alias=> 'Reference S_Rollno',
  p_column_display_sequence=> 5,
  p_column_heading=> 'Reference S_Rollno',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320714614579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
  p_column_alias=> 'Reference Submitted_by',
  p_column_display_sequence=> 6,
  p_column_heading=> 'Reference Submitted_by',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320802038579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
  p_column_alias=> 'Reference A_Subject',
  p_column_display_sequence=> 7,
  p_column_heading=> 'Reference A_Subject',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5320915658579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison A_Id',
  p_column_display_sequence=> 8,
  p_column_heading=> 'Comparison A_Id',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321015617579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison A_Title',
  p_column_display_sequence=> 9,
  p_column_heading=> 'Comparison A_Title',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321103374579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison Submitted_On',
  p_column_display_sequence=> 10,
  p_column_heading=> 'Comparison Submitted_On',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321207644579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison S_Rollno',
  p_column_display_sequence=> 11,
  p_column_heading=> 'Comparison S_Rollno',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321309549579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison Submitted_by',
  p_column_display_sequence=> 12,
  p_column_heading=> 'Comparison Submitted_by',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321423449579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
  p_column_alias=> 'Comparison A_Subject',
  p_column_display_sequence=> 13,
  p_column_heading=> 'Comparison A_Subject',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5321521295579772 + wwv_flow_api.g_id_offset,
  p_region_id=> 5319914188579768 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_page_button(
  p_id             => 5318414429555665 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 20,
  p_button_plug_id => 5318029032555664+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5118632537387232+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Check Plagarism',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
...
wwv_flow_api.create_page_button(
  p_id             => 5318223937555665 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 14,
  p_button_sequence=> 10,
  p_button_plug_id => 5318029032555664+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5319609497555679 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
...
wwv_flow_api.create_page_branch(
  p_id=>5323202021651866 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_branch_action=> 'f?p=&APP_ID.:14:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
...
begin
h := null;
h:=h||'Leave blank to select all assignments';

wwv_flow_api.create_page_item(
  p_id=>5319209466555672 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_A_ID',
  p_data_type=> 'VARCHAR',
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5318029032555664+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Reference Assignment Id',
  p_source_type=> 'ALWAYS_NULL',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'ASSIGNMENT_LOV',
  p_lov=> 'select a_id d, a_id r'||chr(10)||
'from   assignment_master'||chr(10)||
'order by 1',
  p_lov_display_null=> 'YES',
  p_lov_translated=> 'N',
...
begin
h := null;
h:=h||'Leave black to select all assignments';

wwv_flow_api.create_page_item(
  p_id=>5319412567555679 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 14,
  p_name=>'P14_A_ID_1',
  p_data_type=> 'VARCHAR',
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Comparision Assignment Id',
  p_source_type=> 'ALWAYS_NULL',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_named_lov=> 'ASSIGNMENT_LOV',
  p_lov=> 'select a_id d, a_id r'||chr(10)||
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 5117113563387229 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20230601074325'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5127412830387267 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5127515642387272 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5127412830387267+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5127622579387274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5127710907387274 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
...
wwv_flow_api.create_page_process(
  p_id     => 5127910199387275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5127813815387275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5128120199387275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5128025544387275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 5128600505387284 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 5123814907387247 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 5128906262387289 + wwv_flow_api.g_id_offset,
  p_list_id=> 5128600505387284 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>30,
  p_list_item_link_text=> 'Dept Master',
...
wwv_flow_api.create_list_item (
  p_id=> 5129303668387290 + wwv_flow_api.g_id_offset,
  p_list_id=> 5128600505387284 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>70,
  p_list_item_link_text=> 'User Auth',
  p_list_item_link_target=> 'f?p=&FLOW_ID.:13:&SESSION.::&DEBUG.:',
  p_list_countclicks_y_n=> 'N',
  p_list_text_01=> '',
  p_list_item_current_type=> 'COLON_DELIMITED_PAGE_LIST',
...
wwv_flow_api.create_list (
  p_id=> 5132119081387316 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5135611592387337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5139004805387341 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5142404941387344 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list (
  p_id=> 5145803807387347 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
...
--application/shared_components/navigation/lists/admin_panel
 
begin
 
wwv_flow_api.create_list (
  p_id=> 5157113125663514 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Admin Panel',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 5123412603387247 + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_menu (
  p_id=> 5128205733387275 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>5204210726495257 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>null,
  p_option_sequence=>10,
  p_short_name=>'SUBJECT_MASTER',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5204603178498782 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>null,
  p_option_sequence=>10,
  p_short_name=>'SUBJECT_MASTER',
...
wwv_flow_api.create_menu_option (
  p_id=>5323713403651866 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Plagarism Check',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5339110243085892 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Student Report',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5339403294085892 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>5339110243085892 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Form on STUDENT_MASTER',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5350729231314888 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'ASSIGNMENT REPORT',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5351009308314888 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>5350729231314888 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'ASSIGNMENT FORM',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5132201538387319 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>5129519738387291 + wwv_flow_api.g_id_offset,
  p_option_sequence=>20,
  p_short_name=>'Dept Master',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5134129186387331 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>5132201538387319 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_menu_option (
  p_id=>5150925121387356 + wwv_flow_api.g_id_offset,
  p_menu_id=>5128205733387275 + wwv_flow_api.g_id_offset,
  p_parent_id=>5129519738387291 + wwv_flow_api.g_id_offset,
  p_option_sequence=>130,
  p_short_name=>'User Auth',
  p_long_name=>'',
  p_link=>'f?p=105:13:&SESSION.',
  p_page_id=>13,
  p_also_current_for_pages=> '');
...
wwv_flow_api.create_menu (
  p_id=> 5179322895271850 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'subject_breadcum');
...
prompt  ......Page template 5117113563387229
...
wwv_flow_api.create_template(
  p_id=> 5117113563387229 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 5117225191387230
...
wwv_flow_api.create_template(
  p_id=> 5117225191387230 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117324864387230
...
wwv_flow_api.create_template(
  p_id=> 5117324864387230 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117428394387230
...
wwv_flow_api.create_template(
  p_id=> 5117428394387230 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117509371387230
...
wwv_flow_api.create_template(
  p_id=> 5117509371387230 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117631986387231
...
wwv_flow_api.create_template(
  p_id=> 5117631986387231 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117715792387231
...
wwv_flow_api.create_template(
  p_id=> 5117715792387231 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117808118387231
...
wwv_flow_api.create_template(
  p_id=> 5117808118387231 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5117901068387232
...
wwv_flow_api.create_template(
  p_id=> 5117901068387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5118030005387232
...
wwv_flow_api.create_template(
  p_id=> 5118030005387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 5118121856387232
...
wwv_flow_api.create_template(
  p_id=> 5118121856387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5118208108387232
...
wwv_flow_api.create_template(
  p_id=> 5118208108387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5118312795387232
...
wwv_flow_api.create_template(
  p_id=> 5118312795387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5118422904387232
...
wwv_flow_api.create_template(
  p_id=> 5118422904387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5118520897387232
...
wwv_flow_api.create_template(
  p_id=> 5118520897387232 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 5118632537387232
declare
...
wwv_flow_api.create_button_templates (
  p_id=>5118632537387232 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5118714688387235
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5118714688387235 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5118805445387236
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5118805445387236 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5118908517387236
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5118908517387236 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5119026969387236
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5119026969387236 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5119131423387236
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5119131423387236 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5119200140387236
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5119200140387236 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 5119301181387236
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119301181387236 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5119411937387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119411937387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5119523231387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119523231387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5119628439387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119628439387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5119709943387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119709943387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5119803081387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119803081387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5119921706387240
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5119921706387240 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top">'||chr(10)||
...
prompt  ......region template 5120019505387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120019505387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120116534387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120116534387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120224024387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120224024387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5120303269387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120303269387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5120403731387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120403731387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120532722387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120532722387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120610261387241
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120610261387241 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120715377387242
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120715377387242 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5120804239387242
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120804239387242 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5120912531387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5120912531387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5121008523387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121008523387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121105570387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121105570387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121206272387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121206272387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5121325897387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121325897387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121411163387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121411163387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121532287387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121532287387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121607536387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121607536387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5121704623387243
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121704623387243 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5121826632387244
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121826632387244 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="sidebar-region">'||chr(10)||
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5121912634387244
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5121912634387244 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5122005132387244
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5122005132387244 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5122126240387244
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5122126240387244 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5122220479387244
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5122220479387244 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region-wizard" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......list template 5122313712387244
...
wwv_flow_api.create_list_template (
  p_id=>5122313712387244 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5122420421387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5122420421387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5122520664387246
...
wwv_flow_api.create_list_template (
  p_id=>5122520664387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5122600294387246
...
wwv_flow_api.create_list_template (
  p_id=>5122600294387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5122713316387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5122713316387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5122817480387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5122817480387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5122929103387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5122929103387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123010086387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123010086387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123105528387246
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123105528387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123213089387246
...
wwv_flow_api.create_list_template (
  p_id=>5123213089387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123331155387246
...
wwv_flow_api.create_list_template (
  p_id=>5123331155387246 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123412603387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123412603387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123532397387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123532397387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123604523387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123604523387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123710820387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123710820387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123814907387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123814907387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5123901404387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5123901404387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5124013115387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5124013115387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5124131028387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5124131028387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5124222501387247
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5124222501387247 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5124316788387247
...
wwv_flow_api.create_row_template (
  p_id=> 5124316788387247 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124400908387248
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124400908387248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124504351387248
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124504351387248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124613484387248
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124613484387248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124703093387248
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124703093387248 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124823918387249
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124823918387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5124910857387249
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5124910857387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5125009540387249
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5125009540387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5125104365387249
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5125104365387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5125218859387249
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5125218859387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5125331574387249
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5125331574387249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5125409260387250
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5125409260387250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5125502899387250
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5125502899387250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5125612858387250
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5125612858387250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5125714062387250
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5125714062387250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5125824445387250
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5125824445387250 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5125918369387252
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5125918369387252 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5126614391387256
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5126614391387256 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5126021927387252
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5126021927387252 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5126217649387254
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5126217649387254 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5126401730387254
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5126401730387254 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5126715051387259
begin
wwv_flow_api.create_theme (
  p_id =>5126715051387259 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 21,
  ...
  p_login_template=>5117113563387229 + wwv_flow_api.g_id_offset,
  p_default_button_template=>5118632537387232 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5121206272387243 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5120224024387241 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5120303269387241 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5125502899387250 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5125824445387250 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5126021927387252 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5123814907387247 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5125502899387250 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5125714062387250 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 5133130855387323 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5126801159387263
...
wwv_flow_api.create_auth_setup (
  p_id=> 5126801159387263 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5126921805387263
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5126921805387263 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5127024437387264
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5127024437387264 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
